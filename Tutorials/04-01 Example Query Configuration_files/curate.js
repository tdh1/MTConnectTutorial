...
verifyTemplateIsSelected = function(selectedLink)
{
    ...
    $.ajax({
        url : curateVerifyTemplateIsSelected, // "/curate/verify_template_is_selected",
        type : "GET",
        dataType: "json",
...
init_curate = function(){
    $.ajax({
        url : curateInitCurate, // "/curate/init_curate",
        type : "GET",
        dataType: "json",
        async: false,
    });
...
clear_fields = function(){
    $.ajax({
        url : curateClearFields, // "/curate/clear_fields",
        type : "GET",
        dataType: "json",
        success: function(data){
...
view_data = function(formContent){
    $.ajax({
        url : curateViewData, // "/curate/view_data",
        type : "POST",
        dataType: "json",
        data : {
...
{
    $.ajax({
        url : curateValidateXmlData, // "/curate/validate_xml_data",
        type : "POST",
        dataType: "json",
        /*data : {
            xmlString : xmlString,
...
displayTemplateProcess = function ()
{
    if (validateStartCurate()){
       ...
       $.ajax({
            url: curateStartCurate, // "/curate/start_curate",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
...
generate_xsd_form = function(){
    $.ajax({
        url : curateGenerateXsdForm, // "/curate/generate_xsd_form",
        type : "GET",
        dataType: "json",
        success : function(data) {
...
load_xml = function(){
    $.ajax({
        url : curateLoadXml, // "/curate/load_xml",
        type : "GET",
        dataType: "json",
        success : function(data) {
...
download_xml = function(){
    window.location = curateDownloadXml; // '/curate/download_xml';
}
...
downloadXSD = function()
{
    ...
    window.location = curateEnterDataDownloadXsd; // '/curate/enter-data/download-XSD';
...
downloadCurrentXML = function()
{
    ...
    window.location = curateEnterDataDownloadCurrentXml; // '/curate/enter-data/download_current_xml'
...
saveToRepositoryProcess = function(successFunction)
{
   ...
   $.ajax({
        url : curateSaveXmlDataToDb, // "/curate/save_xml_data_to_db",
        type: 'POST',
        data: formData,
        cache: false,
        contentType: false,
...
/*generate = function(tagID, tag){
    ...
    $.ajax({
        url : curateGenerate, // "/curate/generate",
        type : "POST",
        dataType: "json",
        data : {
            tagID : tagID,
...
/*duplicate = function(tagID){
    $.ajax({
        url : curateCanDuplicate, // "/curate/can_duplicate",
        type : "POST",
        dataType: "json",
        data : {
            tagID : tagID,
        ...
        success: function(data){
            if ('occurs' in data){
                if (data.occurs == "zero"){
                    ...
                    $.ajax({
                        url : curateDuplicate, // "/curate/duplicate",
                        type : "POST",
                        dataType: "json",
                        data : {
                            tagID : tagID,
...
$.ajax({
        url : curateCanRemove, // "/curate/can_remove",
        type : "POST",
        dataType: "json",
        data : {
            tagID : tagID,
        ...
        success: function(data){
            if ('occurs' in data){
                if (data.occurs == "zero"){
                    ...
                    var xsdForm = $("#xsdForm").html();
                    $.ajax({
                        url : curateRemove, // "/curate/remove",
                        type : "POST",
                        dataType: "json",
                        data : {
                            tagID : tagID,
...
set_current_template = function(templateID){
    $.ajax({
        url : curateSetCurrentTemplate, // "/curate/set_current_template",
        type : "POST",
        dataType: "json",
        data : {
...
set_current_user_template = function(templateID){
    $.ajax({
        url : curateSetCurrentUserTemplate, // "/curate/set_current_user_template",
        type : "POST",
        dataType: "json",
        data : {
            templateID: templateID
...
delete_form = function(formID){
    $.ajax({
        ...
        url : curateDeleteForm + "?id=" + formID,
        type : "GET",
        dataType: "json",
        data : {
            formID: formID,
		...
		success: function(data){
			...
			window.location = dashboardForms;
	    },
        error:function(data){
			// window.location = "/dashboard/forms"
			window.location = dashboardForms;
...
change_owner_form = function(formID){
    ...
    $.ajax({
        url : curateChangeOwnerForm, // "/curate/change-owner-form",
        type : "POST",
        dataType: "json",
        data : {
            formID: formID,
    ...
    $(function() {
        $( "#dialog-cancel-message" ).dialog({
            ...
            buttons: {
                ...
                Confirm: function() {
                    $.ajax({
                        url : curateCancelForm, // "/curate/cancel-form",
                        type : "GET",
                        dataType: "json",
                        success: function(data){
                            window.location = curateIndex; // "/curate"
                        },
                    });
                },
            }
...
cancelChanges = function(){
    ...
    if( $( "#cancel-form" ).children().size() == 1){
        $.ajax({
            url : curateCancelChanges, // "/curate/cancel-changes",
            type : "GET",
            dataType: "json",
            success: function(data){
...
reload_form = function(){
    $.ajax({
        url : curateReloadForm, // "/curate/reload-form",
        type : "GET",
        dataType: "json",
        success: function(data){
            $("#xsdForm").html(data.xsdForm);
    ...
    if (validateStartCurate()){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                window.location = curateEnterData + '?template=' + template_name
            },
            error:function(data){
                if (data.responseText != ""){
                    $("#form_start_errors").html(data.responseText);
